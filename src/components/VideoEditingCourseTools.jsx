...
export default function VideoEditingCourseTools() {
  return (
      ...
      <Container>
        <Row>
          <div className="text-center mb-4">
            ...
            Master industry-standard video editing and post-production tools such as Premiere Pro, After Effects, DaVinci Resolve, and AI-assisted workflows to build strong editing skills and a studio-ready showreel.
            </p>
          </div>
          ...
          <div className="course-coverage-card rounded-4 shadow-sm p-4">
            <div className="row align-items-center">
              ...
              <div className="col-md-6">
                ...
                Perfect for beginners who want to build strong video editing foundations, learn professional editing techniques, and create a job-ready mini showreel.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="course-coverage-card mt-5 rounded-4 shadow-sm p-4">
            <div className="row align-items-center">
              ...
              <div className="col-md-6">
                <h4 className="fw-bold mb-2">MASTER IN VIDEO EDITING (6 Months)</h4>
                <p className="fw-semibold text-secondary mb-3">
                Learn the core tools used by every professional video editor.
                </p>
                ...
                <p className="text-secondary">
                Perfect for learners who want to master video editing, color grading, motion graphics, and build a professional, studio-ready video editing showreel with real projects.
                </p>
              </div>
            </div>
          </div>
